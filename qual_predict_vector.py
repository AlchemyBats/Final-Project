...
#print("Loading Vector sentiment summary data...")
...
plt.title("Word-Embedding -- Linear Regression Fit")
...
print("\n--- Word-Embedding Prediction Accuracy ---")
print(f"MAE: {mae:.4f}")
print(f"MSE: {mse:.4f}")
print(f"R²:  {r2:.4f}")
...
plt.title("Word-Embedding -- Actual vs Predicted Stock Price Change")
plt.xlabel("Date")
